...
import static nodomain.strive.vimo.devices.miband.MiBandConst.ORIGIN_INCOMING_CALL;
import static nodomain.strive.vimo.devices.miband.MiBandConst.PREF_MI2_ACTIVATE_DISPLAY_ON_LIFT;
import static nodomain.strive.vimo.devices.miband.MiBandConst.PREF_MI2_DATEFORMAT;
import static nodomain.strive.vimo.devices.miband.MiBandConst.PREF_MIBAND_ADDRESS;
import static nodomain.strive.vimo.devices.miband.MiBandConst.PREF_MIBAND_DEVICE_TIME_OFFSET_HOURS;
import static nodomain.strive.vimo.devices.miband.MiBandConst.PREF_MIBAND_FITNESS_GOAL;
import static nodomain.strive.vimo.devices.miband.MiBandConst.PREF_MIBAND_RESERVE_ALARM_FOR_CALENDAR;
import static nodomain.strive.vimo.devices.miband.MiBandConst.PREF_MIBAND_USE_HR_FOR_SLEEP_DETECTION;
import static nodomain.strive.vimo.devices.miband.MiBandConst.PREF_USER_ALIAS;
import static nodomain.strive.vimo.devices.miband.MiBandConst.VIBRATION_COUNT;
import static nodomain.strive.vimo.devices.miband.MiBandConst.getNotificationPrefKey;
