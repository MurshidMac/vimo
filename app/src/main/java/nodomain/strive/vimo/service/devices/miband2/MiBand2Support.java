package nodomain.strive.vimo.service.devices.miband2;
...
import nodomain.strive.vimo.devices.miband.DateTimeDisplay;
import nodomain.strive.vimo.devices.miband.MiBand2Coordinator;
import nodomain.strive.vimo.devices.miband.MiBand2SampleProvider;
...
import nodomain.strive.vimo.entities.User;
import nodomain.strive.vimo.impl.GBAlarm;
import nodomain.strive.vimo.impl.GBDevice;
import nodomain.strive.vimo.impl.GBDevice.State;
...
import nodomain.strive.vimo.model.CalendarEvents;
...
import nodomain.strive.vimo.service.btle.actions.WriteAction;
...
import nodomain.strive.vimo.service.btle.profiles.heartrate.HeartRateProfile;
import nodomain.strive.vimo.service.devices.miband.CheckAuthenticationNeededAction;
import nodomain.strive.vimo.service.devices.miband.NotificationStrategy;
import nodomain.strive.vimo.service.devices.miband.RealtimeSamplesSupport;
import nodomain.strive.vimo.service.devices.miband2.operations.FetchActivityOperation;
import nodomain.strive.vimo.service.devices.miband2.operations.InitOperation;
import nodomain.strive.vimo.service.devices.miband2.operations.UpdateFirmwareOperation;
import nodomain.strive.vimo.util.DateTimeUtils;
import nodomain.strive.vimo.util.GB;
import nodomain.strive.vimo.util.Prefs;

import static nodomain.strive.vimo.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_COLOUR;
import static nodomain.strive.vimo.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_COUNT;
import static nodomain.strive.vimo.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_DURATION;
import static nodomain.strive.vimo.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_ORIGINAL_COLOUR;
import static nodomain.strive.vimo.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_COUNT;
import static nodomain.strive.vimo.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_DURATION;
import static nodomain.strive.vimo.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_PAUSE;
import static nodomain.strive.vimo.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_PROFILE;
import static nodomain.strive.vimo.devices.miband.MiBandConst.FLASH_COLOUR;
import static nodomain.strive.vimo.devices.miband.MiBandConst.FLASH_COUNT;
import static nodomain.strive.vimo.devices.miband.MiBandConst.FLASH_DURATION;
import static nodomain.strive.vimo.devices.miband.MiBandConst.FLASH_ORIGINAL_COLOUR;
import static nodomain.strive.vimo.devices.miband.MiBandConst.VIBRATION_COUNT;
import static nodomain.strive.vimo.devices.miband.MiBandConst.VIBRATION_DURATION;
import static nodomain.strive.vimo.devices.miband.MiBandConst.VIBRATION_PAUSE;
import static nodomain.strive.vimo.devices.miband.MiBandConst.VIBRATION_PROFILE;
import static nodomain.strive.vimo.devices.miband.MiBandConst.getNotificationPrefIntValue;
import static nodomain.strive.vimo.devices.miband.MiBandConst.getNotificationPrefStringValue;
...
public class MiBand2Support extends AbstractBTLEDeviceSupport {
    ...
    private nodomain.strive.vimo.service.devices.miband.DeviceInfo mDeviceInfo;
...
//                .notify(getCharacteristic(MiBandService.UUID_CHARACTERISTIC_SENSOR_DATA), enable);
    ...
    public nodomain.strive.vimo.service.devices.miband.DeviceInfo getDeviceInfo() {
        return mDeviceInfo;
    }
