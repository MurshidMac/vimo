...
import nodomain.strive.vimo.devices.pebble.PebbleHealthSampleProvider;
import nodomain.strive.vimo.devices.pebble.PebbleMisfitSampleProvider;
import nodomain.strive.vimo.entities.AbstractActivitySample;
import nodomain.strive.vimo.entities.ActivityDescription;
import nodomain.strive.vimo.entities.ActivityDescriptionDao;
import nodomain.strive.vimo.entities.DaoSession;
import nodomain.strive.vimo.entities.Device;
import nodomain.strive.vimo.entities.DeviceAttributes;
import nodomain.strive.vimo.entities.DeviceAttributesDao;
import nodomain.strive.vimo.entities.DeviceDao;
import nodomain.strive.vimo.entities.PebbleHealthActivityOverlay;
import nodomain.strive.vimo.entities.PebbleHealthActivityOverlayDao;
import nodomain.strive.vimo.entities.Tag;
import nodomain.strive.vimo.entities.TagDao;
import nodomain.strive.vimo.entities.User;
import nodomain.strive.vimo.entities.UserAttributes;
import nodomain.strive.vimo.entities.UserDao;
...
import nodomain.strive.vimo.model.ValidByDate;
...
import static nodomain.strive.vimo.database.DBConstants.KEY_CUSTOM_SHORT;
import static nodomain.strive.vimo.database.DBConstants.KEY_INTENSITY;
import static nodomain.strive.vimo.database.DBConstants.KEY_STEPS;
import static nodomain.strive.vimo.database.DBConstants.KEY_TIMESTAMP;
import static nodomain.strive.vimo.database.DBConstants.KEY_TYPE;
import static nodomain.strive.vimo.database.DBConstants.TABLE_GBACTIVITYSAMPLES;
