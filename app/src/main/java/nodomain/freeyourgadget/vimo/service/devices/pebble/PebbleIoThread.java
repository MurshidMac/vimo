...
import nodomain.freeyourgadget.vimo.devices.pebble.PBWReader;
import nodomain.freeyourgadget.vimo.devices.pebble.PebbleInstallable;
import nodomain.freeyourgadget.vimo.impl.GBDevice;
import nodomain.freeyourgadget.vimo.impl.DeviceApp;
import nodomain.freeyourgadget.vimo.service.devices.pebble.ble.PebbleLESupport;
import nodomain.freeyourgadget.vimo.service.serial.GBDeviceIoThread;
...
class PebbleIoThread extends GBDeviceIoThread {
    ...
    private DeviceApp mCurrentlyInstallingApp = null;
        ...
        if (hadError) {
            ...
            if (mPebbleProtocol.mFwMajor >= 3) {
                ...
                if (mCurrentlyInstallingApp != null) {
                    if (mCurrentlyInstallingApp.getType() == DeviceApp.Type.WATCHFACE) {
