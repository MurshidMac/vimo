package nodomain.freeyourgadget.vimo.service.devices.miband2;
...
import nodomain.freeyourgadget.vimo.deviceevents.GBDeviceEventBatteryInfo;
import nodomain.freeyourgadget.vimo.deviceevents.GBDeviceEventVersionInfo;
import nodomain.freeyourgadget.vimo.devices.SampleProvider;
import nodomain.freeyourgadget.vimo.devices.miband.DateTimeDisplay;
import nodomain.freeyourgadget.vimo.devices.miband.MiBand2Coordinator;
import nodomain.freeyourgadget.vimo.devices.miband.MiBand2SampleProvider;
import nodomain.freeyourgadget.vimo.devices.miband.MiBand2Service;
import nodomain.freeyourgadget.vimo.devices.miband.MiBandConst;
import nodomain.freeyourgadget.vimo.devices.miband.MiBandCoordinator;
import nodomain.freeyourgadget.vimo.devices.miband.MiBandDateConverter;
import nodomain.freeyourgadget.vimo.devices.miband.MiBandService;
...
import nodomain.freeyourgadget.vimo.entities.MiBandActivitySample;
import nodomain.freeyourgadget.vimo.entities.User;
import nodomain.freeyourgadget.vimo.impl.GBAlarm;
import nodomain.freeyourgadget.vimo.impl.GBDevice;
import nodomain.freeyourgadget.vimo.impl.GBDevice.State;
...
import nodomain.freeyourgadget.vimo.model.CalendarEvents;
import nodomain.freeyourgadget.vimo.model.CallSpec;
import nodomain.freeyourgadget.vimo.model.CannedMessagesSpec;
import nodomain.freeyourgadget.vimo.model.DeviceService;
...
import nodomain.freeyourgadget.vimo.service.btle.BLETypeConversions;
...
import nodomain.freeyourgadget.vimo.service.btle.GattService;
import nodomain.freeyourgadget.vimo.service.btle.TransactionBuilder;
import nodomain.freeyourgadget.vimo.service.btle.actions.AbortTransactionAction;
import nodomain.freeyourgadget.vimo.service.btle.actions.SetDeviceStateAction;
import nodomain.freeyourgadget.vimo.service.btle.actions.WriteAction;
import nodomain.freeyourgadget.vimo.service.btle.profiles.deviceinfo.DeviceInfoProfile;
import nodomain.freeyourgadget.vimo.service.btle.profiles.heartrate.HeartRateProfile;
import nodomain.freeyourgadget.vimo.service.devices.miband.CheckAuthenticationNeededAction;
import nodomain.freeyourgadget.vimo.service.devices.miband.DeviceInfo;
import nodomain.freeyourgadget.vimo.service.devices.miband.NotificationStrategy;
import nodomain.freeyourgadget.vimo.service.devices.miband.RealtimeSamplesSupport;
import nodomain.freeyourgadget.vimo.service.devices.miband2.operations.FetchActivityOperation;
import nodomain.freeyourgadget.vimo.service.devices.miband2.operations.InitOperation;
import nodomain.freeyourgadget.vimo.service.devices.miband2.operations.UpdateFirmwareOperation;
import nodomain.freeyourgadget.vimo.util.DateTimeUtils;
import nodomain.freeyourgadget.vimo.util.GB;
import nodomain.freeyourgadget.vimo.util.Prefs;

import static nodomain.freeyourgadget.vimo.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_COLOUR;
import static nodomain.freeyourgadget.vimo.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_COUNT;
import static nodomain.freeyourgadget.vimo.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_DURATION;
import static nodomain.freeyourgadget.vimo.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_ORIGINAL_COLOUR;
import static nodomain.freeyourgadget.vimo.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_COUNT;
import static nodomain.freeyourgadget.vimo.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_DURATION;
import static nodomain.freeyourgadget.vimo.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_PAUSE;
import static nodomain.freeyourgadget.vimo.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_PROFILE;
import static nodomain.freeyourgadget.vimo.devices.miband.MiBandConst.FLASH_COLOUR;
import static nodomain.freeyourgadget.vimo.devices.miband.MiBandConst.FLASH_COUNT;
import static nodomain.freeyourgadget.vimo.devices.miband.MiBandConst.FLASH_DURATION;
import static nodomain.freeyourgadget.vimo.devices.miband.MiBandConst.FLASH_ORIGINAL_COLOUR;
import static nodomain.freeyourgadget.vimo.devices.miband.MiBandConst.VIBRATION_COUNT;
import static nodomain.freeyourgadget.vimo.devices.miband.MiBandConst.VIBRATION_DURATION;
import static nodomain.freeyourgadget.vimo.devices.miband.MiBandConst.VIBRATION_PAUSE;
import static nodomain.freeyourgadget.vimo.devices.miband.MiBandConst.VIBRATION_PROFILE;
import static nodomain.freeyourgadget.vimo.devices.miband.MiBandConst.getNotificationPrefIntValue;
import static nodomain.freeyourgadget.vimo.devices.miband.MiBandConst.getNotificationPrefStringValue;
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (s.equals(DeviceInfoProfile.ACTION_DEVICE_INFO)) {
                handleDeviceInfo((nodomain.freeyourgadget.vimo.service.btle.profiles.deviceinfo.DeviceInfo) intent.getParcelableExtra(DeviceInfoProfile.EXTRA_DEVICE_INFO));
            }
        }
    };
...
//        }
    ...
    private void handleDeviceInfo(nodomain.freeyourgadget.vimo.service.btle.profiles.deviceinfo.DeviceInfo info) {
