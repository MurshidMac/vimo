...
import nodomain.freeyourgadget.gadgetbridge.BuildConfig;    // this is to add the buildconfig in to the profile
...
public abstract class Logging {
    ...
    public void setupLogging(boolean enable) {
        try {
            ...
            getLogger().info("Vimo version: " + BuildConfig.VERSION_NAME);
