...
import nodomain.freeyourgadget.vimo.activities.AbstractFragmentPagerAdapter;
import nodomain.freeyourgadget.vimo.activities.AbstractGBFragmentActivity;
import nodomain.freeyourgadget.vimo.activities.FwAppInstallerActivity;
...
public class AppManagerActivity extends AbstractGBFragmentActivity {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ABAppManager.class);
    ...
    public class SectionsPagerAdapter extends AbstractFragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return new AppManagerCache();
                case 1:
                    return new AppManagerInstalledApps();
                case 2:
                    return new AppManagerInstalledWatchfaces();
            }
            return null;
        }
