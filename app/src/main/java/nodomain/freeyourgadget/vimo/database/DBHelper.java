package nodomain.freeyourgadget.vimo.database;
...
import nodomain.freeyourgadget.vimo.devices.DeviceCoordinator;
import nodomain.freeyourgadget.vimo.devices.pebble.PebbleHealthSampleProvider;
import nodomain.freeyourgadget.vimo.devices.pebble.PebbleMisfitSampleProvider;
import nodomain.freeyourgadget.vimo.entities.AbstractActivitySample;
import nodomain.freeyourgadget.vimo.entities.ActivityDescription;
import nodomain.freeyourgadget.vimo.entities.ActivityDescriptionDao;
import nodomain.freeyourgadget.vimo.entities.DaoSession;
import nodomain.freeyourgadget.vimo.entities.Device;
import nodomain.freeyourgadget.vimo.entities.DeviceAttributes;
import nodomain.freeyourgadget.vimo.entities.DeviceAttributesDao;
import nodomain.freeyourgadget.vimo.entities.DeviceDao;
import nodomain.freeyourgadget.vimo.entities.PebbleHealthActivityOverlay;
import nodomain.freeyourgadget.vimo.entities.PebbleHealthActivityOverlayDao;
import nodomain.freeyourgadget.vimo.entities.Tag;
import nodomain.freeyourgadget.vimo.entities.TagDao;
import nodomain.freeyourgadget.vimo.entities.User;
import nodomain.freeyourgadget.vimo.entities.UserAttributes;
import nodomain.freeyourgadget.vimo.entities.UserDao;
import nodomain.freeyourgadget.vimo.impl.GBDevice;
import nodomain.freeyourgadget.vimo.model.ActivityKind;
import nodomain.freeyourgadget.vimo.model.ActivitySample;
import nodomain.freeyourgadget.vimo.model.ActivityUser;
import nodomain.freeyourgadget.vimo.model.ValidByDate;
import nodomain.freeyourgadget.vimo.util.DateTimeUtils;
import nodomain.freeyourgadget.vimo.util.DeviceHelper;
import nodomain.freeyourgadget.vimo.util.FileUtils;
...
import static nodomain.freeyourgadget.vimo.database.DBConstants.KEY_INTENSITY;
import static nodomain.freeyourgadget.vimo.database.DBConstants.KEY_STEPS;
import static nodomain.freeyourgadget.vimo.database.DBConstants.KEY_TIMESTAMP;
import static nodomain.freeyourgadget.vimo.database.DBConstants.KEY_TYPE;
