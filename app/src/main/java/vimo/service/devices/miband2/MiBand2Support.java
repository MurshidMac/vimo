...
import vimo.deviceevents.GBDeviceEventBatteryInfo;
import vimo.deviceevents.GBDeviceEventVersionInfo;
import vimo.devices.SampleProvider;
import vimo.devices.miband.DateTimeDisplay;
import vimo.devices.miband.MiBand2Coordinator;
import vimo.devices.miband.MiBand2SampleProvider;
import vimo.devices.miband.MiBand2Service;
import vimo.devices.miband.MiBandConst;
import vimo.devices.miband.MiBandCoordinator;
import vimo.devices.miband.MiBandDateConverter;
...
import vimo.service.btle.BLETypeConversions;
...
import vimo.service.btle.actions.SetDeviceStateAction;
import vimo.service.btle.actions.WriteAction;
import vimo.service.btle.profiles.deviceinfo.DeviceInfoProfile;
import vimo.service.btle.profiles.heartrate.HeartRateProfile;
import vimo.service.devices.miband.CheckAuthenticationNeededAction;
import vimo.service.devices.miband.DeviceInfo;
import vimo.service.devices.miband.NotificationStrategy;
import vimo.service.devices.miband.RealtimeSamplesSupport;
import vimo.service.devices.miband2.operations.FetchActivityOperation;
import vimo.service.devices.miband2.operations.InitOperation;
import vimo.service.devices.miband2.operations.UpdateFirmwareOperation;
import vimo.util.DateTimeUtils;
import vimo.util.GB;
import vimo.util.Prefs;

import static vimo.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_COLOUR;
import static vimo.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_COUNT;
import static vimo.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_DURATION;
import static vimo.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_ORIGINAL_COLOUR;
import static vimo.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_COUNT;
import static vimo.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_DURATION;
import static vimo.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_PAUSE;
import static vimo.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_PROFILE;
import static vimo.devices.miband.MiBandConst.FLASH_COLOUR;
import static vimo.devices.miband.MiBandConst.FLASH_COUNT;
import static vimo.devices.miband.MiBandConst.FLASH_DURATION;
import static vimo.devices.miband.MiBandConst.FLASH_ORIGINAL_COLOUR;
import static vimo.devices.miband.MiBandConst.VIBRATION_COUNT;
import static vimo.devices.miband.MiBandConst.VIBRATION_DURATION;
import static vimo.devices.miband.MiBandConst.VIBRATION_PAUSE;
import static vimo.devices.miband.MiBandConst.VIBRATION_PROFILE;
import static vimo.devices.miband.MiBandConst.getNotificationPrefIntValue;
import static vimo.devices.miband.MiBandConst.getNotificationPrefStringValue;
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (s.equals(DeviceInfoProfile.ACTION_DEVICE_INFO)) {
                handleDeviceInfo((vimo.service.btle.profiles.deviceinfo.DeviceInfo) intent.getParcelableExtra(DeviceInfoProfile.EXTRA_DEVICE_INFO));
            }
        }
    };
...
//        }
    ...
    private void handleDeviceInfo(vimo.service.btle.profiles.deviceinfo.DeviceInfo info) {
