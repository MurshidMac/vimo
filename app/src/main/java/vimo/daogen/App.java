 ...
 * Referred in the Gradle as classpath 'org.greenrobot:greendao-gradle-plugin:4.2.1' // add plugin
 */
package vimo.daogen;
...
public class App {
    ...
    private static final String MAIN_PACKAGE = "com.vimo";  //Creating the Main Package
