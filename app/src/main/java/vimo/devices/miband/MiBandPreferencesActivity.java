...
import vimo.activities.AbstractSettingsActivity;
import vimo.devices.DeviceManager;
import vimo.model.NotificationSpec;
import vimo.model.NotificationType;
import vimo.util.GB;

import static vimo.devices.miband.MiBandConst.ORIGIN_INCOMING_CALL;
import static vimo.devices.miband.MiBandConst.PREF_MI2_ACTIVATE_DISPLAY_ON_LIFT;
import static vimo.devices.miband.MiBandConst.PREF_MI2_DATEFORMAT;
import static vimo.devices.miband.MiBandConst.PREF_MIBAND_ADDRESS;
import static vimo.devices.miband.MiBandConst.PREF_MIBAND_DEVICE_TIME_OFFSET_HOURS;
import static vimo.devices.miband.MiBandConst.PREF_MIBAND_FITNESS_GOAL;
import static vimo.devices.miband.MiBandConst.PREF_MIBAND_RESERVE_ALARM_FOR_CALENDAR;
import static vimo.devices.miband.MiBandConst.PREF_MIBAND_USE_HR_FOR_SLEEP_DETECTION;
import static vimo.devices.miband.MiBandConst.PREF_USER_ALIAS;
import static vimo.devices.miband.MiBandConst.VIBRATION_COUNT;
import static vimo.devices.miband.MiBandConst.getNotificationPrefKey;
